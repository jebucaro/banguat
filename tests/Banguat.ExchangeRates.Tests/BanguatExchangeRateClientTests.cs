...
public class BanguatExchangeRateClientTests
{
    ...
    public async Task GetCurrentUsdRateAsync_Should_DelegateToHandler()
    {
        ...
        IBanguatExchangeRateClient client = CreateClient(getCurrentUsdRate: handler);
    ...
    public async Task GetAvailableCurrenciesAsync_Should_DelegateToHandler()
    {
        ...
        var handler = new RecordingQueryHandler<GetAvailableCurrencies.Query, GetAvailableCurrencies.Response>(expected);
    ...
    public async Task GetUsdRateHistorySinceAsync_Should_DelegateToHandler_WithDate()
    {
        ...
        var handler = new RecordingQueryHandler<GetUsdRateHistorySince.Query, GetUsdRateHistorySince.Response>(expected);
    ...
    public async Task GetCurrencyRateHistorySinceAsync_Should_DelegateToHandler_WithDateAndCurrency()
    {
        ...
        var handler = new RecordingQueryHandler<GetCurrencyRateHistorySince.Query, GetCurrencyRateHistorySince.Response>(expected);
        IBanguatExchangeRateClient client = CreateClient(getCurrencyRateHistorySince: handler);
        var since = new DateOnly(2026, 8, 1);
        var currency = new CurrencyCode(18);

        Result<GetCurrencyRateHistorySince.Response> result = await client.GetCurrencyRateHistorySinceAsync(since, currency);
    ...
    public async Task GetCurrencyRateHistoryAsync_Should_DelegateToHandler_WithDateRangeAndCurrency()
    {
        ...
        var handler = new RecordingQueryHandler<GetCurrencyRateHistory.Query, GetCurrencyRateHistory.Response>(expected);
    ...
    private static BanguatExchangeRateClient CreateClient(
        ...
        RecordingQueryHandler<GetCurrentUsdRateText.Query, GetCurrentUsdRateText.Response>? getCurrentUsdRateText = null,
        RecordingQueryHandler<GetAvailableCurrencies.Query, GetAvailableCurrencies.Response>? getAvailableCurrencies = null,
        RecordingQueryHandler<GetCurrentRate.Query, GetCurrentRate.Response>? getCurrentRate = null,
        RecordingQueryHandler<GetUsdRateHistorySince.Query, GetUsdRateHistorySince.Response>? getUsdRateHistorySince = null,
        RecordingQueryHandler<GetUsdRateHistory.Query, GetUsdRateHistory.Response>? getUsdRateHistory = null,
        RecordingQueryHandler<GetCurrencyRateHistorySince.Query, GetCurrencyRateHistorySince.Response>? getCurrencyRateHistorySince = null,
        RecordingQueryHandler<GetCurrencyRateHistory.Query, GetCurrencyRateHistory.Response>? getCurrencyRateHistory = null)
    {
        return new BanguatExchangeRateClient(
            ...
            getCurrentUsdRateText ?? new RecordingQueryHandler<GetCurrentUsdRateText.Query, GetCurrentUsdRateText.Response>(
                Result.Success(new GetCurrentUsdRateText.Response(string.Empty))),
            getAvailableCurrencies ?? new RecordingQueryHandler<GetAvailableCurrencies.Query, GetAvailableCurrencies.Response>(
            ...
            getUsdRateHistorySince ?? new RecordingQueryHandler<GetUsdRateHistorySince.Query, GetUsdRateHistorySince.Response>(
            ...
            getCurrencyRateHistorySince ?? new RecordingQueryHandler<GetCurrencyRateHistorySince.Query, GetCurrencyRateHistorySince.Response>(
                Result.Success(new GetCurrencyRateHistorySince.Response([]))),
            getCurrencyRateHistory ?? new RecordingQueryHandler<GetCurrencyRateHistory.Query, GetCurrencyRateHistory.Response>(
